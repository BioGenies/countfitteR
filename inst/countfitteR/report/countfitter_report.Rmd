...
`r plik <- as.character(datapath["datapath"])`
`r plik <- as.character(md5sum(plik))`
md5sum of input file: `r ifelse(is.null(input[["input_file"]][["name"]]), "a670b890c279a6b04e84d64482439541", plik)`.
